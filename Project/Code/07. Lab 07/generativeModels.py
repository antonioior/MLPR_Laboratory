...
def generativeModels(D, L, printResults=False):
    ...
    if printResults:
        ...
        print(f"\t\tError rate of Binary MVG: {errorRate_MVG * 100:.1f}%")
        print(f"\t\tError rate of Binary Tied: {errorRate_Tied * 100:.1f}%")
        print(f"\t\tError rate of Naive Bayes: {errorRate_NB * 100:.1f}%")
        print(f"\tPoint 2")
        ...
        print(f"\t\tError rate of Binary MVG: {errorRate_MVG_first_four * 100:.1f}%")
        print(f"\t\tError rate of Binary Tied: {errorRate_Tied_first_four * 100:.1f}%")
        print(f"\t\tError rate of Naive Bayes: {errorRate_NB_first_four * 100:.1f}%")
        print(f"\tPoint 5")
        print(f"\t\tFeature 1 and 2")
        print(f"\t\tError rate of Binary MVG: {errorRate_MVG_first_second * 100:.1f}%")
        print(f"\t\tError rate of Binary Tied: {errorRate_Tied_first_second * 100:.1f}%")
        print(f"\t\tError rate of Naive Bayes: {errorRate_NB_first_second * 100:.1f}%")
        print(f"\t\tFeature 3 and 4")
        print(f"\t\tError rate of Binary MVG: {errorRate_MVG_third_fourth * 100:.1f}%")
        print(f"\t\tError rate of Binary Tied: {errorRate_Tied_third_fourth * 100:.1f}%")
        print(f"\t\tError rate of Naive Bayes: {errorRate_NB_third_fourth * 100:.1f}%")
